...
if not GROQ_API_KEY:
    raise RuntimeError("GROQ_API_KEY is not set. Check your .env or environment.")

SERPAPI_API_KEY = os.getenv("SERPAPI_API_KEY")
if not SERPAPI_API_KEY:
    raise RuntimeError("SERPAPI_API_KEY is not set. Check your .env or environment.")

# _serp_key = os.getenv("SERPAPI_API_KEY")
# if not _serp_key:
#     raise RuntimeError("SERPAPI_API_KEY not found in environment (.env not loaded?)")

# SERPAPI_API_KEY = SecretStr(_serp_key)
